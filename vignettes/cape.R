...
plotSinglescan(final_cross, singlescan_obj, line_type = "h", lwd = 2, 
covar_label_size = 1)
...
var_inf_file <- here("demo", "demo_qtl", "variant.influences.jpg")
cat(paste0("![](", var_inf_file, ")\n"))

## ----circ_net, results = "asis", echo = FALSE---------------------------------------------------------------------------------------------------------------
circ_net_file <- here("demo", "demo_qtl", "Network.Circular.jpg")
cat(paste0("![](", circ_net_file, ")\n"))

## ----net_vis, results = "asis", echo = FALSE----------------------------------------------------------------------------------------------------------------
net_file <- here("demo", "demo_qtl", "Network.View.jpg")
cat(paste0("![](", net_file, ")\n"))

## ----plotrlang::last_error()_main, fig.width = 7, fig.height = 3--------------------------------------------------------------------------------------------
plotEffects(data_obj = final_cross, geno_obj = obesity_geno, 
