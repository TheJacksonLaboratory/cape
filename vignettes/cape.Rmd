...
```{r eigentraits, results = "asis", echo = FALSE, out.width = '100%'}
svd.file <- here("demo", "demo_qtl", "svd.jpg")
knitr::include_graphics(svd.file)
```
...
```{r reparam_fig, results = "asis", echo = FALSE, out.width='100%'}
reparam.file <- here("vignettes", "reparam.png")
knitr::include_graphics(reparam.file)
```
