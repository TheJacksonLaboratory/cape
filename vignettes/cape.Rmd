...
The function `norm.pheno` uses quantile normalization to fit the 
...
new plotting function in cape called `plotEffects` that can be used
...
`plotEffects`. First to verify the positive effect of the marker on Chr 15,
