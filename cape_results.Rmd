...
```{r svd, results = "asis", echo = FALSE, error=TRUE}
...
```{r singlescan_effects, results = "asis", echo = FALSE, error=TRUE}
...
```{r singlescan_std, results = "asis", echo = FALSE, error=TRUE}
...
```{r variant_influences, results = "asis", echo = FALSE, error=TRUE}
...
```{r circular_network, results = "asis", echo = FALSE, error=TRUE}
...
```{r network_layout, results = "asis", echo = FALSE, error=TRUE}
fig.file <- file.path(results_dir, "Network_View.jpg")
fig.line <- paste0("![Network Layout](", fig.file, ")\n")
cat(fig.line)
```
...
```{r var_inf_table, echo = FALSE, error=TRUE}
...
```{r var_int_table, echo = FALSE, error=TRUE}
...
```{r line_plot, error=TRUE}
plot_effects(data_obj, geno_obj, var.inf[1,"Source"], var.inf[1,"Target"], 
plot_type = "l", error_bars = "se", pheno_type = "eig", gen_model1 = "Recessive")
```
...
```{r bar_plot, error=TRUE}
plot_effects(data_obj, geno_obj, var.inf[1,"Source"], var.inf[1,"Target"],
plot_type = "b", error_bars = "se", pheno_type = "eig", gen_model1 = "Recessive")
```
...
```{r point_plot, error=TRUE}
plot_effects(data_obj, geno_obj, var.inf[1,"Source"], var.inf[1,"Target"],
plot_type = "p", error_bars = "se", pheno_type = "eig", gen_model1 = "Recessive")
```
...
```{r, add_table, echo = FALSE, error=TRUE}
...
```{r, dom_table, echo = FALSE, error=TRUE}
...
```{r, rec_table, echo = FALSE, error=TRUE}
