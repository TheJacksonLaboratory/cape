...
#' @param border.col The color of the border of the pie chart. Use NA
#' to omit the border.
#' @param node.border.lwd The thickness of the border line
...
#' @param label.cex A numeric value giving the size of the label text.
