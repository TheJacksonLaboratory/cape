...
#' save_permutations is TRUE all permutation data are saved in an object called "permutation.data.RData".
...
direct_influence <- function(data_obj, pairscan_obj, transform_to_phenospace = TRUE, 
  ...
  if(save_permutations){
    data_obj$save_rds(intermediate_data, "permutation.data.RData")
  }	
