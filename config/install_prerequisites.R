...
install.packages(c("testthat", "here", "devtools", "evd","fdrtool","shape","corpcor","doParallel","foreach","caTools","abind","propagate","tidyr","data.table","RcppEigen","RSQLite","qtl","regress","BiocManager","igraph", "RColorBrewer"),repos = "http://cran.us.r-project.org")
